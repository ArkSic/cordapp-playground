...
class DriverBasedTest {
    ...
    fun `node test`() = withDriver {
        ...
        // From each node, make an RPC call to retrieve another node's name from the mockNet map, to verify that the
    ...
    // Makes an RPC call to retrieve another node's name from the mockNet map.
